                        ...
                        <div class="grid items-center grid-cols-12 col-span-12 gap-4 md:col-span-9">
                            <div class="flex flex-col col-span-12 gap-1 md:col-span-5 lg:col-span-4">
                                <div class="flex md:flex-col lg:gap-2 lg:flex-row">
                                    <p class="text-sm text-secondary-500">{{ __('Name') }}:</p>
                                    <p class="text-sm">{{ $ticket->data->data->first_name . ' ' . $ticket->data->data->last_name }}</p>
                                </div>
                                <div class="flex md:flex-col lg:gap-2 lg:flex-row">
                                    <p class="text-sm text-secondary-500">{{ __('Email') }}:</p>
                                    <p class="text-sm">{{ $ticket->data->data->email }}</p>
                                </div>
                            </div>

                            <div class="flex flex-col col-span-12 gap-1 md:col-span-4">
                                <div class="flex md:flex-col lg:gap-2 lg:flex-row">
                                    <p class="text-sm text-secondary-500">{{ __('Ticket price') }}:</p>
                                    <p class="text-sm">{{ number_format($ticket->ticket_price) }} {{ __('Toman') }}</p>
                                </div>
                                <div class="flex md:flex-col lg:gap-2 lg:flex-row">
                                    <p class="text-sm text-secondary-500">{{ __('Paid price') }}:</p>
                                    <p class="text-sm">{{ number_format($ticket->order_price) }} {{ __('Toman') }}</p>
                                </div>
                            </div>
                            ...
                            <div class="flex flex-col col-span-3 col-span-12 gap-1 lg:col-span-4">
                                <div class="flex md:flex-col lg:gap-2 lg:flex-row">
                                    <p class="text-sm text-secondary-500">{{ __('Discount code') }}:</p>
                                    <p class="text-sm">{{ $ticket->discount_code }}</p>
                                </div>
                                @if($ticket->discount_price != 0)
                                <div class="flex md:flex-col lg:gap-2 lg:flex-row">
                                    <p class="text-sm text-secondary-500">{{ __('Discount price') }}:</p>
                                    <p class="text-sm">{{ $ticket->discount_price }} {{ __('Toman') }}</p>
                                </div>
                                @endif
                                @if($ticket->discount_percentage != 0)
                                <div class="flex md:flex-col lg:gap-2 lg:flex-row">
                                    <p class="text-sm text-secondary-500">{{ __('Discount percentage') }}:</p>
                                    <p class="text-sm">%{{ $ticket->discount_percentage }}</p>
                                </div>
                                @endif
                            </div>
                            @endif
