                ...
                <div class="flex gap-4">
                    ...
                    <div class="grid items-center w-full grid-cols-12 lg:gap-6">
                        ...
                        <div class="grid items-center grid-cols-12 col-span-12 gap-4 md:col-span-9">
                            <div
                                class="flex flex-col col-span-12 gap-1 sm:flex-row md:flex-col md:col-span-5 lg:col-span-4">
                                <div class="flex w-full md:flex-col lg:gap-2 lg:flex-row">
                                    <p class="w-full text-sm text-start text-secondary-500">{{ __('Name') }}:</p>
                                    <p class="w-full text-sm text-start ">{{ $ticket->data->data->first_name . ' ' .
                                        $ticket->data->data->last_name }}</p>
                                </div>
                                <div class="flex w-full md:flex-col lg:gap-2 lg:flex-row">
                            ...
                            <div
                                class="flex flex-col col-span-12 gap-1 sm:flex-row md:flex-col md:col-span-3 lg:col-span-4">
                                <div class="flex w-full md:flex-col lg:gap-2 lg:flex-row">
                                ...
                                <div class="flex w-full md:flex-col lg:gap-2 lg:flex-row">
                                    <p class="w-full text-sm text-start text-secondary-500">{{ __('Discount percentage')
                                        }}:</p>
