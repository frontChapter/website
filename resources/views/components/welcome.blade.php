<div class="p-6 lg:p-8 bg-white dark:bg-secondary-800 dark:bg-gradient-to-bl dark:from-secondary-700/50 dark:via-transparent border-b border-secondary-200 dark:border-secondary-700">
    ...
    <p class="mt-6 text-secondary-500 dark:text-secondary-400 leading-relaxed">
...
<div class="bg-secondary-200 dark:bg-secondary-800 bg-opacity-25 grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8 p-6 lg:p-8">
    <div>
        <div class="flex items-center">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" class="w-6 h-6 stroke-secondary-400">
                <path stroke-linecap="round" stroke-linejoin="round" d="M12 6.042A8.967 8.967 0 006 3.75c-1.052 0-2.062.18-3 .512v14.25A8.987 8.987 0 016 18c2.305 0 4.408.867 6 2.292m0-14.25a8.966 8.966 0 016-2.292c1.052 0 2.062.18 3 .512v14.25A8.987 8.987 0 0018 18a8.967 8.967 0 00-6 2.292m0-14.25v14.25" />
            </svg>
            <h2 class="ms-3 text-xl font-semibold text-secondary-900 dark:text-white">
                <a href="https://laravel.com/docs">Documentation</a>
            </h2>
        </div>

        <p class="mt-4 text-secondary-500 dark:text-secondary-400 text-sm leading-relaxed">
