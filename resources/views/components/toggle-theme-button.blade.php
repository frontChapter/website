<x-button.circle flat type="button" x-data="{
    toggleTheme: () => {
...
}" x-on:click="toggleTheme(2)">
    <svg id="themeToggleDarkIcon" class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
    ...
    <svg id="themeToggleLightIcon" class="hidden w-5 h-5" fill="currentColor" viewBox="0 0 20 20"
        ...
        <path
            ...
            fill-rule="currentColor" clip-rule="currentColor"></path>
    </svg>
</x-button.circle>
